...
const strengths: Strength[] = [
  {
    title: "仮説検証を回す思考の型",
    description:
      "未経験の業務に取り組むとき、まず情報を集めて仮説を立て、実行・検証・改善を繰り返しながら成果物を形にすることを意識してきた。理学療法士として患者ごとの評価と介入計画を繰り返してきた経験を、IT領域での課題解決にも応用している。",
  },
  {
  ...
  },
  {
    title: "戦略的に組み立てる思考",
    description:
      "理学療法士時代の経験から、状況を整理して仮説を立て、最善手を選ぶPDCAサイクルに楽しさを感じてきた。この思考の癖が、現在のIT業務や学習計画の組み立てにも活きている。",
  },
];
